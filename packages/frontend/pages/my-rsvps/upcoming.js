...
// Fetch all RSVPs from the User's account
...
export default function MyUpcomingRSVPs() {
  ...
  // Get the address as the account or set to empty string if not found
    ...
    <Dashboard page="rsvps" isUpcoming={true}>
      {
        account ? (
          ...
          <div className="flex flex-col items-center py-8">
            <p className="mb-4">Please connect wallet to view RSVPs</p>
            <ConnectButton/>
          </div>
        )}
    </Dashboard>
