...
export default function CreateEvent() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      const alertMessage = "ERROR: Something went wrong, Please refresh and try again.";
      // Create an HTTP response for the POST method using the event details
      ...
      console.log(alertMessage + `ERROR MESSAGE: ${error}`);
    }
  }
  ...
  const createEvent = async (cid) => {
    try {
      ...
      if (rsvpContract) {
        ...
        const transaction = await createNewEvent(
          eventTimestamp,
          deposit,
          maxCapacity,
          eventDataCID,
        ...
        console.log("Minted: ", transaction.hash);
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className="relative py-12">
          ...
          }
          {
            success && eventID && (
              <div>
                Success! Please wait a few minutes, the check out your event page{" "}
