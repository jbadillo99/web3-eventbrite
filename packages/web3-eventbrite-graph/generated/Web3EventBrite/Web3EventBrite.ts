...
export class Web3EventBrite__idToEventResult {
  value0: Bytes;
  value1: string;
  value2: Address;
  value3: BigInt;
...
export class Web3EventBrite extends ethereum.SmartContract {
  static bind(address: Address): Web3EventBrite {
    return new Web3EventBrite("Web3EventBrite", address);
  }

  idToEvent(param0: Bytes): Web3EventBrite__idToEventResult {
    ...
    return new Web3EventBrite__idToEventResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_idToEvent(
    param0: Bytes
  ): ethereum.CallResult<Web3EventBrite__idToEventResult> {
    ...
    return ethereum.CallResult.fromValue(
      new Web3EventBrite__idToEventResult(
        value[0].toBytes(),
        value[1].toString(),
        value[2].toAddress(),
        value[3].toBigInt(),
